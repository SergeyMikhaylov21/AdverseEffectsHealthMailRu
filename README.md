...
<ol>
	...
	<li>Морфологизатор (можно воспользоваться инструментами из [GATE плагина](https://gate.ac.uk/gate/doc/plugins.html#Lang_Russian) для русского языка. Основная задача этого инструмента - сформировать для каждого слова аннотацию Morph, где в атрибуте baseForm будет записана начальная форма слова)</li>
	...
	<li>Apply Classification - инструмент для запуска классификации (один из ресурсов загружаемого [плагина](https://gatenlp.github.io/gateplugin-LearningFramework/) GATE Learning Framework).</li>
</ol>
